...
Up until Generation 6, there are 721 Pokemon species founded in the wild. Some of them have multiple forms (which differ in the distribution of stats), raising the number of all different versions of Pokemon species captured in this data set to `r nrow(data)`. 
...
## **Pokemon Types - Another decisive factor**
